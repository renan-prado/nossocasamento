...
import { SecondConfirmationSection } from "@/components/SecondConfirmationSection";
...
export default function Home() {
  return (
    <main className="snap-y snap-mandatory overflow-hidden overflow-y-scroll h-screen w-screen">
      ...
      >
        <Image
          src="/mosaico/mosaico (29).JPG"
          alt=""
          fill
          className="absolute inset-0 object-cover brightness-[0.18] grayscale"
          priority={false}
        />
        <GuestManualSection />
      </SnapSection>
      ...
      <SnapSection
        name="rsvp"
        className="bg-bege hidden gap-8 px-6 py-10 text-green"
      >
        <Image
      ...
      <SnapSection name="venue" className="bg-black px-6 py-8">
        ...
        <div className="relative z-10 flex flex-col gap-6 items-center text-center text-green-foreground">
          <div className="flex flex-col gap-6">
            ...
            <h2 className="text-3xl font-serif font-bold leading-tight">25/06/26 · 14:30h</h2>
